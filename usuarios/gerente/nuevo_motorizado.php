            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Nuevo Motorizado/a</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fa-solid fa-user-plus"></i>
                                Agregando un nuevo Motorizado/a
                            </div>
                            <div class="card-body">
                                <form action="registrar_nuevo_motorizado.php" method="post" class="mw-100 my-3 mx-4">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <input type="hidden" name="perfil_usua" value="4">
                                        <div class="col-md-3 position-relative">
                                    ...
                                    <input type="submit" class="btn btn-success mt-3" value="Agregar Motorizado">
                                </form>
                            </div>
                        </div>
                    </div>
