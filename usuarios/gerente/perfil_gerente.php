                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7">
                                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                <div class="card-header"><h3 class="text-center font-weight-light my-4">GERENTE</h3></div>
                                                <div class="card-body">
                                                    <form action="actualizar_gerente.php" id="actualizarperfil" method="post" class="mw-100 my-3 mx-4">
