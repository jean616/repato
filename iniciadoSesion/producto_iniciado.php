                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="detalle_prod_iniciado.php?id_prod=<?php echo $base['id_prod'];?> &token=<?php echo hash_hmac('sha1', $base['id_prod'], KEY_TOKEN); ?>" class="btn btn-primary"><i class="bi bi-ticket-detailed-fill"></i> Detalles</a>
                                        </div> 
                                            <a href="carrito_iniciado.php" class="btn btn-success"><i class="bi bi-bag-fill"></i> Agregar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
