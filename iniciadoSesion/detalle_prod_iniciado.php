...
?>
        ...
        <div class="bg-light py-3">
                <div class="container">
                        <div class="row">
                        <div  class="col-md-12 mb-0 fs-5"><a href="producto_iniciado.php" class="text-danger" style="text-decoration: none;">Productos</a> <span class="mx-2 mb-0">/</span>
                            ...
                            <div class="col-md-5" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="btn-group">
                                        <p><a href="carrito_iniciado.php" class="buy-now btn btn-lg btn-danger"><i class="bi bi-cart-check-fill"></i>Añadir al carrito</a></p>
                                        </div> 
                                    </div>
                                </div>
                        </div>
